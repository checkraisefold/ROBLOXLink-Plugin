...
RESCOMP = windres
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/libROBLOXLink.so
...
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=libROBLOXLink.so
...
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=libROBLOXLink.so -s
...
$(OBJDIR)/dllmain.o: src/dllmain.cpp
	@echo $(notdir $<)
